...
namespace Fungus
{
    ...
    [RequireComponent(typeof(MusicManagerFungus))]
    ...
    public sealed class FungusManager : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            MusicManagerFungus = GetComponent<MusicManagerFungus>();
        ...
        /// </summary>
        public MusicManagerFungus MusicManagerFungus { get; private set; }
