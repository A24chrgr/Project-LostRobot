    ...
    public class WriterAudio : MonoBehaviour, IWriterListener
    {
        ...
        protected virtual AudioSource VoiceOverAudioSource
        {
            get
            {
                ...
                AudioSource voiceOverSource = FungusManager.Instance.MusicManagerFungus.DefaultVoiceAudioSource;
        ...
        protected virtual AudioSource EffectAudioSource
        {
            get
            {
                ...
                AudioSource voiceOverSource = FungusManager.Instance.MusicManagerFungus.WriterSoundEffectAudioSource;
